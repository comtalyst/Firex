...
const int left_forward_fast = 1830;       // CCW Fast
...
const int stepsAwayBefore90 = 7;                    // initialize turn(this) in opposite direction before do the sharp turn to prevent crashing
